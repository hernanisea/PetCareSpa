...
public class ServicioService {
    ...
    public Servicio crearServicio(String nombre, String descripcion, Integer precio, Long idComentario,Long idReserva, TipoServicio tipoServicio) {
    ...
    public Servicio actualizar(Long id, String nombre, String descripcion, Integer precio, Long idComentario,Long idReserva, TipoServicio tipoServicio) {
