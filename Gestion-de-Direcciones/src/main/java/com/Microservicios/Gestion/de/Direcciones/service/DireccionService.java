...
public class DireccionService {
    ...
    Comuna comuna = comunaRepository.findById(dto.getComuna().getIdComuna())
            .orElseThrow(() -> new IllegalArgumentException("Comuna no encontrada con ID: " + dto.getComuna().getIdComuna()));
